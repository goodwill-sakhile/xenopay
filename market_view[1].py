                            ...
                            ScrollView:
                                ...
                                ExChangeMarketsLayout:
                                    ...
                                    ExChangeMarketsBarBox:
                                        ticker_logo:"dollar.jpg"
                                        ticker_symbol:"USDZAR=X"
                                        text_color:[0, 1, 154/float(255), 1]
                                    ExChangeMarketsBarBox:
                                        ticker_logo:"pound.jpg"
                                        ticker_symbol:"GBPZAR=X"
                                    ExChangeMarketsBarBox:
                                        ticker_logo:"euro.jpg"
        ...
        MDBoxLayout:
            ...
            CryptoButtonBox:
                ...
                MDLabel:
                    ...
                    valign:"middle"
                    color:[0, 0, 0, 1]
            CurrencyViewButtonBox:
                id:currency_button_box
...
class ExChangeMarketsLayout(MDGridLayout):
    def __init__(self, **kwargs):
        ...
        self.size_hint_x = None
        self.bind(minimum_width = self.setter("width"))
class CryptoButtonBox(TouchBox):
    def respondToTouch(self):
        self.md_bg_color = [190/float(255), 190/float(255), 190/float(255), 1]
        self.children[0].color = [0, 0, 0, 1]
        self.parent.root.ids.currency_button_box.md_bg_color = [0/float(255), 154/float(255), 255/float(255), 1]
        self.parent.root.ids.currency_button_box.children[0].color = [1, 1, 1, 1]
        self.parent.root.ids.body_screen_manager.transition = SlideTransition(direction = "right")
        self.parent.root.ids.body_screen_manager.current = "crypto_market_screen"
class CurrencyViewButtonBox(TouchBox):
    def respondToTouch(self):
        self.md_bg_color = [190/float(255), 190/float(255), 190/float(255), 1]
        self.children[0].color = [0, 0, 0, 1]
        self.parent.root.ids.crypto_button_box.md_bg_color = [0/float(255), 154/float(255), 255/float(255), 1]
        self.parent.root.ids.crypto_button_box.children[0].color = [1, 1, 1, 1]
        self.parent.root.ids.body_screen_manager.transition = SlideTransition(direction = "left")
        self.parent.root.ids.body_screen_manager.current = "currency_market_screen"
...
#class Test(MDApp):
    #def build(self):
        #root = MarketsViewScreen()
       # thread.start_new_thread(root.plotAllGraphs, ("BTC-USD", "DOGE-USD", "ETH-USD"))
        #thread.start_new_thread(root.plotAllGraphs, ("USDZAR=X", "GBPZAR=X", "EURZAR=X"))
        #return root
